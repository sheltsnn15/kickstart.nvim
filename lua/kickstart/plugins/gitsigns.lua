...
return {
  ...
  opts = {
    on_attach = function(bufnr)
      ...
      -- Actions
      -- Visual mode
      map('v', '<leader>gss', function() gitsigns.stage_hunk { vim.fn.line '.', vim.fn.line 'v' } end, { desc = 'Git [S]tage Git hunk' })
      map('v', '<leader>gsr', function() gitsigns.reset_hunk { vim.fn.line '.', vim.fn.line 'v' } end, { desc = 'Git [R]eset Git hunk' })
      ...
      map('n', '<leader>gsD', function() gitsigns.diffthis '@' end, { desc = 'Git [D]iff against last commit' })
