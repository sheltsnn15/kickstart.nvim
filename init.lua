...
do
    ...
    vim.keymap.set('n', '<leader>tq', function()
        ...
        desc = '[T]oggle diagnostic [Q]uickfix'
    })
...
do
    ...
    local telescope_plugins = {gh 'nvim-lua/plenary.nvim', gh 'nvim-telescope/telescope.nvim',
    ...
    require('telescope').setup {
        ...
        -- pickers = {}
        defaults = {
            file_ignore_patterns = {'^.git/', '^node_modules/', '^dist/', '^build/', '^target/', '^vendor/',
                                    '__pycache__/', '%.lock$'}
        },
        extensions = {
...
do
    ...
    -- Linters
    'ansible-lint', 'shellcheck', 'cpplint', 'cmakelint', 'stylelint', 'hadolint', 'golangci-lint', 'eslint_d', 'vale',
    'luacheck', 'markdownlint', 'ruff', 'sqlfluff', 'yamllint', -- Formatters
    'shfmt', 'clang-format', 'prettierd', 'goimports', 'gofumpt', 'stylua', 'yamlfmt', -- LSPs
    'bash-language-server', 'dockerfile-language-server', 'gopls', 'json-lsp', 'lua-language-server', 'marksman',
    'pyright', 'vtsls', 'yaml-language-server', -- Debuggers
    'delve', 'debugpy', 'bash-debug-adapter', 'js-debug-adapter', 'codelldb'})
...
do
    ...
    local parsers = {'bash', 'c', 'cpp', 'diff', 'dockerfile', 'go', 'html', 'javascript', 'jsdoc', 'lua', 'luadoc',
                     'markdown', 'markdown_inline', 'python', 'query', 'regex', 'rust', 'tsx', 'typescript', 'vim',
                     'vimdoc', 'yaml'}
